...
<body>
	<!-- 网页顶部导航 -->
	<#include "common/head-tpl.ftl" /> <#assign currentNav = "index" />
	<!-- 网页导航 -->
	<#include "common/navbar-tpl.ftl" />

	<!-- banner广告部分 start -->
	<div class="container-fuil">
		<div id="carousel-banner-generi" class="carousel slide el-banner"
			data-ride="carousel">
			<ol class="carousel-indicators">
				<li data-target="#carousel-banner-generi" data-slide-to="0"
					class="active"></li>
			...
			<!-- Controls -->
			<a class="left carousel-control" href="#carousel-banner-generi"
				role="button" data-slide="prev">
				<span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
				<span class="sr-only">Previous</span>
			</a>
			<a class="right carousel-control" href="#carousel-banner-generi"
	...
	<div class="container el-panel">
		<div class="panel el-panel">
			<div class="panel-title">
				...
				<div class="pull-right">
					<a class="btn btn-link " href="/invest.do"> 进入投资列表 </a>
				</div>
			</div>
			<table class="table el-table table-hover">
				...
				<tbody>
					<#if bidRequests?size &gt; 0 > <#list bidRequests as data>
					<tr>
		...
		<div class="panel el-panel">
			<div class="panel-title">
				...
				<div class="pull-right">
					<a class="btn btn-link " href=""> 更多资讯 </a>
				</div>
			</div>
