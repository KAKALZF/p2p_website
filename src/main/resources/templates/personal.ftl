		...
		$("#bindEmail").click(function() {
			$("#bindEmailForm").ajaxSubmit({
				...
				success : function(data) {
					if (data.success) {
						$.messager.confirm("提示", "发送成功", function() {
...
<body>
	...
	<#assign currentNav="index"/> <#include "common/navbar-tpl.ftl" />

	<div class="container">
		<div class="row">
			<!--导航菜单-->
			<#assign currentMenu="ipLog">
			<div class="col-sm-3"><#include "common/leftmenu-tpl.ftl" /></div>
			<!-- 功能页面 -->
			<div class="col-sm-9">
				<div class="panel panel-default">
					<div class="panel-body el-account">
						...
						<div class="row h4 account-info">
							<div class="col-sm-4">
								账户总额：${account.totalAmount?string("#0.00")}
								<span class="text-primary">元</span>
							</div>
							<div class="col-sm-4">
								可用金额：${account.usableAmount}
								<span class="text-primary">元</span>
							</div>
							<div class="col-sm-4">
								冻结金额：${account.freezedAmount}
								<span class="text-primary">元</span>
							</div>
						</div>
						...
						<div class="row h4 account-info">
							...
							<div class="col-sm-4">
								待还本息：${account.unReturnAmount}
								<span class="text-primary">元</span>
							</div>
						</div>
						<div class="row h4 account-info">
							<div class="col-sm-4">
								体验金可用余额：${expAccount.usableAmount}
								<span class="text-primary">元</span>
							</div>
							<div class="col-sm-4">
								体验金冻结余额：${expAccount.freezedAmount}
								<span class="text-primary">元</span>
							</div>
							<div class="col-sm-4">
								体验金待回收总额：${expAccount.unReturnExpAmount}
								<span class="text-primary">元</span>
							</div>
						</div>
